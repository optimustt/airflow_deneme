...
args = {
    "project_id": "untitled111-1012073804",
}

dag = DAG(
    "untitled111-1012073804",
    default_args=args,
...
op_dacade7f_d171_441f_ae4a_0f36ea060a12 = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "untitled111-{{ ts_nodash }}",
    },
    volumes=[],
    volume_mounts=[],
    secrets=[],
